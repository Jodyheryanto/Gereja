...
class AdminDiakoniController extends Controller
{
    /**
    ...
    function showCreateForm(){
        return view('admin.Direktori.Komisi.Diakoni.create');
    }
    ...
    public function create(Request $request)
	{
        ...
        Komisi::insert([
            ...
            'bagian_komisi' => 'diakoni'
        ]);
        return redirect()->route('admin.direktori.komisi.diakoni.list');
        // ->with('success', 'Course successfully created!');
    }
    
    function showEditForm($id){
        $anggota = Komisi::where('id', $id)->first();
        return view('admin.Direktori.Komisi.Diakoni.edit', compact(['anggota']));
    }
    ...
    function list(){
        $anggota = Komisi::where('bagian_komisi', 'diakoni')->orderBy('jabatan', 'ASC')->get();
        return view('admin.Direktori.Komisi.Diakoni.list', compact(['anggota']));
    }
}
