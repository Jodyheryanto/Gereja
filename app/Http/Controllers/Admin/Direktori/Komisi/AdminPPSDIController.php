...
class AdminPPSDIController extends Controller
{
    /**
    ...
    function showCreateForm(){
        return view('admin.Direktori.Komisi.PPSDI.create');
    }
    ...
    public function create(Request $request)
	{
        ...
        return redirect()->route('admin.direktori.komisi.ppsdi.list');
        // ->with('success', 'Course successfully created!');
    }
    
    function showEditForm($id){
        $anggota = Komisi::where('id', $id)->first();
        return view('admin.Direktori.Komisi.PPSDI.edit', compact(['anggota']));
    }
    ...
    function list(){
        $anggota = Komisi::where('bagian_komisi', 'ppsdi')->orderBy('jabatan', 'ASC')->get();
        return view('admin.Direktori.Komisi.PPSDI.list', compact(['anggota']));
    }
}
