...
class AdminPekesController extends Controller
{
    /**
    ...
    function showCreateForm(){
        return view('admin.Direktori.Komisi.Pekes.create');
    }
    ...
    public function create(Request $request)
	{
        ...
        return redirect()->route('admin.direktori.komisi.pelayanan-kesaksian.list');
        // ->with('success', 'Course successfully created!');
    }
    
    function showEditForm($id){
        $anggota = Komisi::where('id', $id)->first();
        return view('admin.Direktori.Komisi.Pekes.edit', compact(['anggota']));
    }
    ...
    function list(){
        $anggota = Komisi::where('bagian_komisi', 'pekes')->orderBy('jabatan', 'ASC')->get();
        return view('admin.Direktori.Komisi.Pekes.list', compact(['anggota']));
    }
}
