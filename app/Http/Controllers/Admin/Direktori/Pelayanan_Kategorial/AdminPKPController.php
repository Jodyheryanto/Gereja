...
class AdminPKPController extends Controller
{
    /**
    ...
    function showCreateForm(){
        return view('admin.Direktori.Pelayanan_Kategorial.Persekutuan_Kaum_Perempuan.create');
    }
    ...
    public function create(Request $request)
	{
        ...
        Pelayanan_Kategorial::insert([
            ...
            'bagian_pelayanan' => 'pkp'
        ]);
        return redirect()->route('admin.direktori.pelayanan-kategorial.pkp.list');
        // ->with('success', 'Course successfully created!');
    }
    
    function showEditForm($id){
        $anggota = Pelayanan_Kategorial::where('id', $id)->first();
        return view('admin.Direktori.Pelayanan_Kategorial.Persekutuan_Kaum_Perempuan.edit', compact(['anggota']));
    }
    ...
    function list(){
        $anggota = Pelayanan_Kategorial::where('bagian_pelayanan', 'pkp')->orderBy('id', 'ASC')->get();
        return view('admin.Direktori.Pelayanan_Kategorial.Persekutuan_Kaum_Perempuan.list', compact(['anggota']));
    }
}
