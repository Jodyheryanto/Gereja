...
class AdminGPController extends Controller
{
    ...
    function showCreateForm(){
        return view('admin.Direktori.Pelayanan_Kategorial.Gerakan_Pemuda.create');
    }
    ...
    public function create(Request $request)
	{
        ...
        return redirect()->route('admin.direktori.pelayanan-kategorial.gp.list');
        // ->with('success', 'Course successfully created!');
    }
    
    function showEditForm($id){
        $anggota = Pelayanan_Kategorial::where('id', $id)->first();
        return view('admin.Direktori.Pelayanan_Kategorial.Gerakan_Pemuda.edit', compact(['anggota']));
    }
    ...
    function list(){
        $anggota = Pelayanan_Kategorial::where('bagian_pelayanan', 'gp')->orderBy('id', 'ASC')->get();
        return view('admin.Direktori.Pelayanan_Kategorial.Gerakan_Pemuda.list', compact(['anggota']));
    }
}
