  ...
  <div class="container text-middle h-100">
    <div class="row justify-content-center align-self-center text-center">
      <div class="intro-info order-md-first order-last text-center">
        ...
        <h2 style="color: black; -webkit-text-stroke: 1px white;" class="m-0"><strong>Persekutuan Kaum Bapak<br>GPIB Sejahtera Jakarta</strong></h2>
    ...
    <div class="container">
      <div class="row align-items-center">
        <div class="col-12 col-lg-8">
          ...
          <h4>PELAYANAN KATEGORIAL (PELKAT) PERSEKUTUAN KAUM BAPAK (PKB)</h4>
          @if($masa_bakti !== NULL)
        ...
        <div class="col-12 col-lg-4">
          <img src="/img/LOGO-PELKAT-PKB.png" alt="logo" class="filter-image" style="max-height: 300px; width: auto;">
        </div>
        </div>
        <div class="row">
            <div class="col-12 col-lg-8">
              <a href="http://www.instagram.com/pkb.gpibsejahtera.jkt" target="_blank"><img id="img-pre" src="/images/pelayanan_kategorial/{{ $post->link }}" style="width: 100%; height: auto;" alt="your image" /></a>
