  ...
  <div class="container text-middle h-100">
    <div class="row justify-content-center align-self-center text-center">
      <div class="intro-info order-md-first order-last text-center">
        ...
        <h2 style="color: black; -webkit-text-stroke: 1px white;"><strong>Komisi Diakoni<br>GPIB Sejahtera Jakarta</strong></h2>
        ...
        <table class="table table-striped text-center">
          <thead>
            <tr class="table-primary">
              <th scope="col" colspan="@auth 3 @endauth @guest 2 @endguest">Diakoni</th>
            </tr>
          </thead>
          <tbody>
