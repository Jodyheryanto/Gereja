...
@section('title', 'Edit Anggota Germasa')

@section('content')

<div class="element-wrapper">
    <h6 class="element-header">Edit Anggota Komisi Germasa</h6>
    <div class="element-content">
        <div class="element-box">
            <form id="formValidate" action="{{ route('admin.direktori.komisi.germasa.update') }}" method="POST" enctype="multipart/form-data">
                {{csrf_field()}}
