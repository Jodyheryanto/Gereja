...
@section('title', 'Musik Gerejawi')

@section('content')

<div class="element-wrapper">
    <h6 class="element-header">Data Anggota Komisi Musik Gerejawi</h6>
    <div class="element-content">
        <a href="{{ route('direktori.komisi.musik-gerejawi') }}" target="_blank" class="btn btn-primary mb-4">Live Preview & Edit</a>
        <a href="{{ route('admin.direktori.komisi.musik-gerejawi.showCreateForm') }}" class="btn btn-success mb-4"><i class="fa fa-page"></i>Create</a>
