...
@section('title', 'Edit Anggota Musik Gerejawi')

@section('content')

<div class="element-wrapper">
    <h6 class="element-header">Edit Anggota Komisi Musik Gerejawi</h6>
    <div class="element-content">
        <div class="element-box">
            <form id="formValidate" action="{{ route('admin.direktori.komisi.musik-gerejawi.update') }}" method="POST" enctype="multipart/form-data">
                {{csrf_field()}}
