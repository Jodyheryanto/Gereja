...
@section('title', 'Tambah Anggota PPSDI - PPK')

@section('content')

<div class="element-wrapper">
    <h6 class="element-header">Tambah Anggota Komisi PPSDI</h6>
    <div class="element-content">
        <div class="element-box">
            <form id="formValidate" action="{{ route('admin.direktori.komisi.ppsdi.create') }}" method="POST" enctype="multipart/form-data">
                {{csrf_field()}}
