...
@section('title', 'Tambah Anggota Teologi dan Persidangan Gereja')

@section('content')

<div class="element-wrapper">
    <h6 class="element-header">Tambah Anggota Komisi Teologi dan Persidangan Gereja</h6>
    <div class="element-content">
        <div class="element-box">
            <form id="formValidate" action="{{ route('admin.direktori.komisi.teologi.create') }}" method="POST" enctype="multipart/form-data">
                {{csrf_field()}}
                <h5 class="form-header">Form Anggota Komisi Teologi dan Persidangan Gereja</h5>
                <div class="row">
                    <div class="col-sm-6">
