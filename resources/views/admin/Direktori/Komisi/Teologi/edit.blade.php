...
@section('title', 'Edit Anggota Teologi dan Persidangan Gereja')

@section('content')

<div class="element-wrapper">
    <h6 class="element-header">Edit Anggota Komisi Teologi dan Persidangan Gereja</h6>
    <div class="element-content">
        <div class="element-box">
            <form id="formValidate" action="{{ route('admin.direktori.komisi.teologi.update') }}" method="POST" enctype="multipart/form-data">
                {{csrf_field()}}
