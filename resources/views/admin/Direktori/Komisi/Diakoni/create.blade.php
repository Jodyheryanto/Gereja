...
@section('title', 'Tambah Anggota Diakoni')

@section('content')

<div class="element-wrapper">
    <h6 class="element-header">Tambah Anggota Komisi Diakoni</h6>
    <div class="element-content">
        <div class="element-box">
            <form id="formValidate" action="{{ route('admin.direktori.komisi.diakoni.create') }}" method="POST" enctype="multipart/form-data">
                {{csrf_field()}}
