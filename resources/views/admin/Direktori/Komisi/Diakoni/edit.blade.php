...
@section('title', 'Edit Anggota Diakoni')

@section('content')

<div class="element-wrapper">
    <h6 class="element-header">Edit Anggota Komisi Diakoni</h6>
    <div class="element-content">
        <div class="element-box">
            <form id="formValidate" action="{{ route('admin.direktori.komisi.diakoni.update') }}" method="POST" enctype="multipart/form-data">
                {{csrf_field()}}
