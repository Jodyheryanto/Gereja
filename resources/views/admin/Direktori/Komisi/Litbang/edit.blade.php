...
@section('title', 'Edit Anggota Inforkom Litbang')

@section('content')

<div class="element-wrapper">
    <h6 class="element-header">Edit Anggota Komisi Inforkom Litbang</h6>
    <div class="element-content">
        <div class="element-box">
            <form id="formValidate" action="{{ route('admin.direktori.komisi.inforkom-litbang.update') }}" method="POST" enctype="multipart/form-data">
                {{csrf_field()}}
