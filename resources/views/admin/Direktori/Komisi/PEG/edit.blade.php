...
@section('title', 'Edit Anggota PEG')

@section('content')

<div class="element-wrapper">
    <h6 class="element-header">Edit Anggota Komisi PEG</h6>
    <div class="element-content">
        <div class="element-box">
            <form id="formValidate" action="{{ route('admin.direktori.komisi.peg.update') }}" method="POST" enctype="multipart/form-data">
                {{csrf_field()}}
