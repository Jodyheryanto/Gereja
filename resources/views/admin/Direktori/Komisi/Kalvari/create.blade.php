...
@section('title', 'Tambah Anggota Kalvari')

@section('content')

<div class="element-wrapper">
    <h6 class="element-header">Tambah Anggota Komisi Kalvari</h6>
    <div class="element-content">
        <div class="element-box">
            <form id="formValidate" action="{{ route('admin.direktori.komisi.kalvari.create') }}" method="POST" enctype="multipart/form-data">
                {{csrf_field()}}
                <h5 class="form-header">Form Anggota Komisi Kalvari</h5>
                <div class="row">
                    <div class="col-sm-6">
