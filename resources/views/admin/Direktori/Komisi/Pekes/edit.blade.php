...
@section('title', 'Edit Anggota Pelayanan dan Kesaksian')

@section('content')

<div class="element-wrapper">
    <h6 class="element-header">Edit Anggota Komisi Pelayanan dan Kesaksian</h6>
    <div class="element-content">
        <div class="element-box">
            <form id="formValidate" action="{{ route('admin.direktori.komisi.pelayanan-kesaksian.update') }}" method="POST" enctype="multipart/form-data">
                {{csrf_field()}}
