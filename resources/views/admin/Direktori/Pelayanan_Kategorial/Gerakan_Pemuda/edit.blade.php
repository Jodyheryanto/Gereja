...
@section('title', 'Edit Anggota GP')

@section('content')

<div class="element-wrapper">
    <h6 class="element-header">Edit Anggota Gerakan Pemuda</h6>
    <div class="element-content">
        <div class="element-box">
            <form id="formValidate" action="{{ route('admin.direktori.pelayanan-kategorial.gp.update') }}" method="POST" enctype="multipart/form-data">
                {{csrf_field()}}
