...
@section('title', 'Tambah Anggota PKLU')

@section('content')

<div class="element-wrapper">
    <h6 class="element-header">Tambah Anggota Persekutuan Kaum Lanjut Usia</h6>
    <div class="element-content">
        <div class="element-box">
            <form id="formValidate" action="{{ route('admin.direktori.pelayanan-kategorial.pklu.create') }}" method="POST" enctype="multipart/form-data">
                {{csrf_field()}}
