...
@section('title', 'Tambah Anggota Pelayanan Anak')

@section('content')

<div class="element-wrapper">
    <h6 class="element-header">Tambah Anggota Pelayanan Anak</h6>
    <div class="element-content">
        <div class="element-box">
            <form id="formValidate" action="{{ route('admin.direktori.pelayanan-kategorial.pa.create') }}" method="POST" enctype="multipart/form-data">
                {{csrf_field()}}
                <h5 class="form-header">Form Anggota Pelayanan Anak</h5>
                <div class="row">
                    <div class="col-sm-6">
