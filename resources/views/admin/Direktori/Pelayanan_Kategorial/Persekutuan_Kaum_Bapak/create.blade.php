...
@section('title', 'Tambah Anggota PKB')

@section('content')

<div class="element-wrapper">
    <h6 class="element-header">Tambah Anggota Persekutuan Kaum Bapak</h6>
    <div class="element-content">
        <div class="element-box">
            <form id="formValidate" action="{{ route('admin.direktori.pelayanan-kategorial.pkb.create') }}" method="POST" enctype="multipart/form-data">
                {{csrf_field()}}
                <h5 class="form-header">Form Anggota Persekutuan Kaum Bapak</h5>
                <div class="row">
                    <div class="col-sm-6">
