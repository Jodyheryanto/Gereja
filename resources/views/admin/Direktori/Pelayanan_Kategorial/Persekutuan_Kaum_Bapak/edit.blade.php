...
@section('title', 'Edit Anggota PKB')

@section('content')

<div class="element-wrapper">
    <h6 class="element-header">Edit Anggota Persekutuan Kaum Bapak</h6>
    <div class="element-content">
        <div class="element-box">
            <form id="formValidate" action="{{ route('admin.direktori.pelayanan-kategorial.pkb.update') }}" method="POST" enctype="multipart/form-data">
                {{csrf_field()}}
