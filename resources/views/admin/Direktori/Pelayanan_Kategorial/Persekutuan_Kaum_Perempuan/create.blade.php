...
@section('title', 'Tambah Anggota PKP')

@section('content')

<div class="element-wrapper">
    <h6 class="element-header">Tambah Anggota Persekutuan Kaum Perempuan</h6>
    <div class="element-content">
        <div class="element-box">
            <form id="formValidate" action="{{ route('admin.direktori.pelayanan-kategorial.pkp.create') }}" method="POST" enctype="multipart/form-data">
                {{csrf_field()}}
                <h5 class="form-header">Form Anggota Persekutuan Kaum Perempuan</h5>
                <div class="row">
                    <div class="col-sm-6">
