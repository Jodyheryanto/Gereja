...
<div class="element-wrapper">
    ...
    <div class="element-content">
        <a href="{{ route('direktori.pendeta-jemaat') }}" target="_blank" class="btn btn-primary mb-4">Live Preview & Edit</a>
        <a href="{{ route('admin.direktori.pendeta.showCreateForm') }}" class="btn btn-success mb-4"><i class="fa fa-page"></i>Create</a>
            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ $data->gpib }}</td>
                        <td><img class="card-img-top" src="/images/pendeta/{{ $data->foto }}" style="width: auto; height: 50px" alt="Card image cap"></td>
                        <td>
