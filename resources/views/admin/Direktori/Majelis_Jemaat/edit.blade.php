...
@section('title', 'Edit Anggota Majelis Jemaat')

@section('content')

<div class="element-wrapper">
    <h6 class="element-header">Edit Anggota Majelis Jemaat</h6>
    <div class="element-content">
        <div class="element-box">
            <form id="formValidate" action="{{ route('admin.direktori.majelis-jemaat.update') }}" method="POST" enctype="multipart/form-data">
                {{csrf_field()}}
                <input type="hidden" name="id" value="{{ $anggota->id }}">
                <h5 class="form-header">Form Anggota Komisi Diakoni</h5>
                <div class="row">
                    <div class="col-sm-6">
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input class="form-control" name="jabatan" data-error="Sektor Pelayanan tidak boleh kosong" placeholder="Masukkan jabatan" required="required" value="{{ $anggota->jabatan }}">
                            <div class="help-block form-text with-errors form-control-feedback"></div>
                        </div>
                    </div>
                </div>
