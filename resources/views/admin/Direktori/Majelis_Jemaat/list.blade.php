...
<div class="element-wrapper">
    <h6 class="element-header">Data Anggota Majelis Jemaat</h6>
    <div class="element-content">
        <a href="{{ route('direktori.majelis-jemaat') }}" target="_blank" class="btn btn-primary mb-4">Live Preview & Edit</a>
        <a href="{{ route('admin.direktori.majelis-jemaat.showCreateForm') }}" class="btn btn-success mb-4"><i class="fa fa-page"></i>Create</a>
